...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex md:flex-col w-64 shrink-0 bg-slate-900 border-r border-slate-800 text-slate-300 h-screen sticky top-0">
        {navContent}
      </aside>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-slate-900 border-r border-slate-800 text-slate-300 transition-transform duration-300 ease-in-out md:hidden',
