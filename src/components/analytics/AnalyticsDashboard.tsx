  ...
  if (isLoading) return (
    <div className="flex items-center justify-center h-[70vh]">
      <div className="flex flex-col items-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium tracking-widest text-sm">AGGREGATING DATA...</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-200 dark:border-slate-800">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight">System Analytics</h1>
          <p className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm mt-0.5">Historical trends, aggregated performance metrics &amp; fleet health</p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
            ...
            {TIME_RANGES.map(({ label, hours }) => (
              <button
                ...
                className={`px-3 py-1.5 text-sm font-semibold rounded-lg transition-all duration-200 ${
                  timeRange === hours
                    ? 'bg-blue-600 text-slate-900 dark:text-white shadow-md shadow-blue-900/30'
          ...
          <select
            ...
            className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer hover:border-slate-600 transition-colors"
          >
      ...
      {fleetStats && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Total Readings */}
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-300 dark:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 bg-blue-50 dark:bg-blue-500/10 rounded-xl"><Activity size={18} className="text-blue-400" /></div>
              <span className="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Total Readings</span>
            </div>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">{fleetStats.total.toLocaleString()}</div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-300 dark:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 bg-red-50 dark:bg-red-500/10 rounded-xl"><AlertTriangle size={18} className="text-red-400" /></div>
              <span className="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Alert Rate</span>
            </div>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">
              {fleetStats.alertRate}<span className="text-lg text-slate-500 dark:text-slate-400 ml-0.5">%</span>
            </div>
            <div className="text-xs text-slate-500 mt-1">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-300 dark:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl"><CheckCircle size={18} className="text-emerald-400" /></div>
              <span className="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Fleet Uptime</span>
            </div>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">
              {fleetStats.uptime}<span className="text-lg text-slate-500 dark:text-slate-400 ml-0.5">%</span>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-300 dark:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Avg Fuel Level</span>
            </div>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">
              {fleetStats.avgFuel}<span className="text-lg text-slate-500 dark:text-slate-400 ml-0.5">%</span>
            </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4 px-1">
          ...
          <h2 className="text-base font-semibold text-slate-900 dark:text-white">Alert Analytics</h2>
          <span className="text-xs text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-full">threshold breach summary</span>
        </div>

        {/* Alert type pill strip */}
        {alertBreakdown && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-5">
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-500/20 rounded-xl p-4 text-center hover:bg-red-500/15 transition-colors">
            ...
            <div className="bg-purple-50 dark:bg-purple-500/10 border border-purple-500/20 rounded-xl p-4 text-center hover:bg-purple-500/15 transition-colors">
              <div className="flex items-center justify-center gap-1.5 mb-2">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 text-center hover:bg-yellow-500/15 transition-colors">
              <div className="flex items-center justify-center gap-1.5 mb-2">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4 px-1">
          ...
          <h2 className="text-base font-semibold text-slate-900 dark:text-white">Device Health Overview</h2>
          <span className="text-xs text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-full">{devices.length} devices</span>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4 px-1">
          ...
          <h2 className="text-base font-semibold text-slate-900 dark:text-white">Metric Trends</h2>
          {selectedDevice !== 'all' && (
            <span className="text-xs text-blue-400 bg-blue-50 dark:bg-blue-500/10 border border-blue-500/20 px-2 py-0.5 rounded-full">
